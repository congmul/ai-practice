# Run This file on Terminal with this,
...
def main():
    ...
    try:
        ...
        secret_key = keyvault_client.get_secret("AI-Services-Key-West")
        ...
        # Background removal
        BackgroundForeground(endpoint=ai_endpoint, key=cog_key, image_file=image_file)
